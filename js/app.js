(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-partners__slider")) new swiper_core_Swiper(".slider-partners__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.5,
        ...
        if (document.querySelector(".good__slider")) new swiper_core_Swiper(".good__slider", {
            ...
            navigation: {
                prevEl: ".good__slider-button--left",
                nextEl: ".good__slider-button--right"
            },
            on: {}
        });
    }
